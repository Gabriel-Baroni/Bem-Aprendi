window.onload = function () {
 ...
 const stage = new createjs.Stage("gameCanvas");
  ...
  // PERSONAGEM
  const personagem = new createjs.Bitmap("/static/img/logica/prof.png"); // substitua pelo caminho da sua imagem
  personagem.x = 800;
  personagem.y = 200;
...
// DIÁLOGO DO PROFESSOR
  const nomePersonagem = "Prof. Dua";
  const imagemPersonagem = "/static/img/logica/prof.png";
  const falas = [
    "Olá, aluno como vai?",
    "Eu sou o Professor Duá, um Tamanduá!",
    "Você está pronto para começar nosso super legal DESAFIO DE LÓGICA?!",
